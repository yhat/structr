...
test_that("list.py creates an instance of a pylist", {
  x <- list.py(1, 2, "a")
...
test_that("is.list.py can identify a list", {
  x <- list.py(1, 2, "a")
  y <- 1:100
  z <- list(1, 2, 3)
  expect_that(is.list.py(x), is_true())
  expect_that(is.list.py(y), is_false())
  expect_that(is.list.py(z), is_false())
})
